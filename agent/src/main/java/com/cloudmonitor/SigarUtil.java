...
public class SigarUtil {
   ...
   /* public static void printCpuPerc(CpuPerc cpu) {
	...
	public static NetIoState net() throws Exception {
		...
		Long rxPackets = Long.valueOf(0);
		Long txPackrts = Long.valueOf(0);
		Long rxBytes = Long.valueOf(0);
		Long txBytes = Long.valueOf(0);
...
/*            System.out.println("网络设备名:    " + name);// 网络设备名
        ...
        /*    System.out.println(name + "接收的总包裹数:" + ifstat.getRxPackets());// 接收的总包裹数
			...
			txPackrts += ifstat.getTxPackets();
			rxBytes += ifstat.getRxBytes();
			txBytes += ifstat.getTxBytes();
		}
		netIoState.setHostname(commonConfig.getBindIp());
		netIoState.setRxpck(String.valueOf(rxPackets / 1024 / 1024));
		netIoState.setTxpck(String.valueOf(txPackrts / 1024 / 1024));
		netIoState.setRxbyt(String.valueOf(rxBytes / 1024 / 1024 / 1024));
		netIoState.setTxbyt(String.valueOf(txBytes / 1024 / 1024 / 1024));
		return netIoState;
	}
