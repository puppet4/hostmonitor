...
import com.cloudmonitor.common.ApplicationContextHelper;
import com.cloudmonitor.config.MailConfig;
...
public class WarnMailUtil {
	...
	public static final String content_suffix = "<p><a target='_blank' href='http://www.wgstart.com'>cloudmonitor监控系统</a>敬上";
    ...
    public   static String sendMail(String mails,String mailTitle,String mailContent){
        try {
                ...
                email.setFrom(StaticKeys.mailSet.getFromMailName(), "cloudmonitor监控系统");//发信者
